...
const IncomingCallScreen = () => {
  const { showCallScreen, hideCallScreen, incomingCallInfo, startCall } =
    useCallStore();
  ...
  const receiveCall = async () => {
    ...
    router.push(
      replacePlaceholders(ROUTES.CALL_USER, {
        id: incomingCallInfo?.additionalInfo?.user_id,
      }) as any
    );
  };

  return (
    <Modal visible={showCallScreen} animationType="slide" transparent={false}>
