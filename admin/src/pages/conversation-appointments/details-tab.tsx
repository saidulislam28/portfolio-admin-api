        ...
        <Row gutter={[24, 24]}>
            ...
            <Col xs={24} lg={12}>
                ...
                >
                    <Space direction="vertical" size="large" style={{ width: "100%" }}>
                        ...
                        <div>
                            <Text strong>
                                <RightCircleFilled style={{ marginRight: "8px", color: "#722ed1" }} />
                                Status
                            </Text>
                            <br />
                            <Tag
            ...
            <Col xs={24} lg={12}>
                <Card
                    ...
                    extra={
                        <Button
                            type="primary"
                            onClick={() => navigate(`/users/details/${appointmentData?.User?.id}`)}
                        >
                            View Details
                        </Button>
                    }
                ...
                >
                    <Space direction="vertical" size="large" style={{ width: "100%" }}>
                        ...
                        <Space direction="vertical" size="middle" style={{ width: "100%" }}>
                            ...
                            <div>
                                <ClockCircleOutlined style={{ marginRight: "8px", color: "#722ed1" }} />
                                <Text>Timezone: {appointmentData?.User?.timezone ?? "Dhaka"}</Text>
                            </div>
                        </Space>
                    </Space>
                </Card>
            ...
            <Col xs={24}>
                <Card
                    ...
                    extra={
                        <Space size={"middle"}>
                            <Button type="default" onClick={() => handleAssignClick(appointmentData?.id)}>
                                Assign
                            </Button>
                            {appointmentData?.Consultant && (
                                <Button
                                    type="primary"
                                    onClick={() =>
                                        navigate(`/consultants/details/${appointmentData?.Consultant?.id}`)
                                    }
                                >
                                    View Details
                                </Button>
                ...
                >
                    {appointmentData?.Consultant?.id ? (
                        <Row gutter={[24, 24]}>
                            <Col xs={24} md={8}>
                                <div style={{ textAlign: "center" }}>
                                    <Badge dot={appointmentData?.Consultant?.is_verified} color="green">
                                        <Avatar
                                            size={80}
                                            icon={<IdcardOutlined />}
