...
export class InvoicePdfGeneratorService {
    ...
    private addHeader(doc: PDFKit.PDFDocument): void {
        ...
        doc.fontSize(20)
            ...
            .text('Email: Info.speakingmate@gmail.co', 50, 90)
            .text('Phone: +88 09678 771912', 50, 105);
    ...
    private addFooter(doc: PDFKit.PDFDocument): void {
        ...
        doc.fontSize(8)
            ...
            .text('For any queries, please contact us at Info.speakingmate@gmail.co', 50, footerY + 12)
