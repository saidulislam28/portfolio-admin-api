...
const Service_Manager = () => {
    ...
    const {
        ...
        staleTime: 0,
        select: (data) => {
            const filteredData = data?.data?.filter(i => i.section_type === CORPORATE_PAGE_TYPE.CORPORATE_REVIEW)
            return filteredData ?? []
        }
    });
    ...
    const onFinish = async (formValues: any) => {
        const payload = {
            ...
            section_type: CORPORATE_PAGE_TYPE.CORPORATE_REVIEW,
        };
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <h1 style={{ fontWeight: 'bold', fontSize: 24 }}>Review Section</h1>
