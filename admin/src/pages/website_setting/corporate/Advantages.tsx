...
const Advantages = () => {
    ...
    const KEY = 'get advantages' + model;
    ...
    const {
        ...
        staleTime: 0,
        select: (data) => {
            const filteredData = data?.data?.filter(i => i.section_type === CORPORATE_PAGE_TYPE.ADVANTAGES)
            return filteredData ?? []
        }
    });
    ...
    const onFinish = async (formValues: any) => {
        const payload = {
            ...
            content: formValues.cards.map((card, index) => {
                ...
                // console.log(card?.image[0]?.response?.url)
            ...
            section_type: CORPORATE_PAGE_TYPE.ADVANTAGES,
        };
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <h1 style={{ fontWeight: 'bold', fontSize: 24 }}> Advantages Section </h1>
