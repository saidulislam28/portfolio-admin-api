 ...
 */
function parseUTCTimeForComparison(utcTimeString) {
 ...
 */
export function categorizeAppointments(appointments, deviceTimezone) {
 ...
 */
export function formatAppointmentTime(utcTimeString, userTimezone) {
