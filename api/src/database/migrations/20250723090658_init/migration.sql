-- CreateTable
CREATE TABLE "speaking_test_feedbacks" (
    "id" SERIAL NOT NULL,
    ...
    CONSTRAINT "speaking_test_feedbacks_pkey" PRIMARY KEY ("id")
);

-- AddForeignKey
ALTER TABLE "speaking_test_feedbacks" ADD CONSTRAINT "speaking_test_feedbacks_consultant_id_fkey" FOREIGN KEY ("consultant_id") REFERENCES "consultants"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "speaking_test_feedbacks" ADD CONSTRAINT "speaking_test_feedbacks_appointment_id_fkey" FOREIGN KEY ("appointment_id") REFERENCES "appointments"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "speaking_test_feedbacks" ADD CONSTRAINT "speaking_test_feedbacks_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
