 ...
 */
export const sendCallStartNotificationToUser = async (
 ...
 */
export const sendCallEndNotificationToUser = async (
  appointment_id: number
) => {
  try {
 ...
 */
export const sendCallStartNotificationToConsultant = async (
  appointment_id: number
) => {
  try {
 ...
 * @throws {void} Does not throw — errors are caught and logged to console.
 */
export const sendCallEndNotificationToConsultant = async (
  appointment_id: number
) => {
  try {
