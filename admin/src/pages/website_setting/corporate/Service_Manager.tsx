...
const Service_Manager = () => {
    ...
    const {
        ...
        staleTime: 0,
        select: (data) => {
            const filteredData = data?.data?.filter(i => i.section_type === CORPORATE_PAGE_TYPE.SERVICE_MANAGER)
            return filteredData ?? []
        }
    });
    ...
    const onFinish = async (formValues: any) => {
        const payload = {
            ...
            //  return   console.log("imageUrl", imageUrl)
            ...
            section_type: CORPORATE_PAGE_TYPE.SERVICE_MANAGER,
        };
        // return
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <h1 style={{ fontWeight: 'bold', fontSize: 24 }}>Service Manager Section</h1>
                                    ...
                                    <>
                                        ...
                                        {fields.map(({ key, name, ...restField }) => (
                                            <div key={key} style={{
                                                ...
                                                >
                                                    <Input placeholder="Managing Director, Director etc." />
                                                </Form.Item>
                                                <Form.Item
                                                    {...restField}
...
export default Service_Manager;
